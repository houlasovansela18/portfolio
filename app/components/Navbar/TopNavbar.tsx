...
export default function TopNavbar() {
	...
	return (
		<div className="bg-transparent h-24 mx-auto w-11/12 sm:w-5/6 md:w-3/4 lg:w-3/4 xl:w-2/3 2xl:w-1/2 flex flex-row justify-between items-center border-b-2 border-opacity-10">
